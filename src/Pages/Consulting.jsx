      ...
      <div className="container">
        <div className="row g-5">
          <div className="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <p>
              Even with an experienced accounts team, navigating complex
              financial challenges often requires an outside perspective. This
              service focuses on enhancing your team’s efforts, offering
              strategic advice to tackle obstacles like compliance issues,
              inefficiencies, or planning for growth. Every recommendation is
              tailored to your business’s unique situation, ensuring practical
              solutions that fit your industry and goals.
            </p>
            <ul>
              <li>
                <a href="#">Ensuring compliance with relevant regulations</a>
              </li>
              <li>
                <a href="#">Identifying and mitigating potential risks</a>
              </li>
              <li>
                <a href="#">Streamlining processes to control expenses</a>
              </li>
              <li>
                <a href="#">Developing strategies to boost profitability</a>
              </li>
            </ul>
            <p />
          </div>
          ...
          <div className="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
            <img className="img-fluid" src="assets/img/Analysis-pana.svg" />
          </div>
        </div>
      </div>
      {/* Features End */}
        ...
        <div className="faq-container">
          <div className="faq-item">
            <div className="faq-title" onclick="toggleFAQ(this)">
              <center> How do you work with in-house teams? </center>{" "}
              <span>+</span>
            </div>
            <div className="faq-content">
              We collaborate closely with your team, providing support and
              advice to help them navigate challenges and improve overall
              performance.
            </div>
          </div>
          <div className="faq-item">
            ...
            <div className="faq-content">
              We work with a variety of sectors, including retail, tech, and
              manufacturing, tailoring our services to fit your industry’s
              unique needs.
            </div>
          </div>
          <div className="faq-item">
            <div className="faq-title" onclick="toggleFAQ(this)">
              Can you help us prepare for market expansion? <span>+</span>
            </div>
            <div className="faq-content">
              Yes, we can guide you through financial planning, risk assessment,
              and compliance to make the process smoother.
            </div>
          </div>
        </div>
      </section>
